...
public interface IControlFacturaProveedor {
    ...
    public double guardarFacturaProveedor(FacturaProveedor p,Vector items,Vector cambioPrecio,Vector prEntrConIva, Vector ganancias,Vector nuevoPrecioVtaSinIva,Vector nuevoPrecioVtaConIva,Long itFGuardada)throws Exception;
}
