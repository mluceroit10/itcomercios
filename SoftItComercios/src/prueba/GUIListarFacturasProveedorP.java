...
public class GUIListarFacturasProveedorP extends JDialog {
	...
	private InputMap map = new InputMap();
	 ...
	 public GUIListarFacturasProveedorP(int mes,int anio,JFrame guiPadre) {
	    	super(guiPadre);
	    	mesLI=mes;
			anioLI=anio;
    ...
    public GUIListarFacturasProveedorP(int mes,int anio,JDialog guiPadre) {
    	super(guiPadre);
    	mesLI=mes;
		anioLI=anio;
		datos = new Object[0][titulos.length];
    ...
    private JLabel getJLProveedor() {
        if (cliente == null) {
        	...
        	cliente.setBounds(new Rectangle(390,25,130,15));
        }
        return cliente;
    }
