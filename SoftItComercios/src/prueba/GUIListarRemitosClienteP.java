...
public class GUIListarRemitosClienteP extends JDialog {
    ...
    public GUIListarRemitosClienteP(int mes,int anio,JFrame guiPadre) {
    	super(guiPadre);
    	mesLI=mes;
		anioLI=anio;
    ...
    public GUIListarRemitosClienteP(int mes,int anio,JDialog guiPadre) {
    	super(guiPadre);
    	mesLI=mes;
		anioLI=anio;
		datos = new Object[0][titulos.length];
