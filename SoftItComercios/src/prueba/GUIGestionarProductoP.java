...
public class GUIGestionarProductoP extends JDialog {
    ...
    public GUIGestionarProductoP(JFrame guiPadre) {
    	super(guiPadre);
    	datos = new Object[0][titulos.length];
        this.setSize(740,540);//.setSize(Utils.anchoMaxVent,Utils.largoMaxVent);  //
    ...
    private JPanel getJPBuscador() {
    	if (jpBuscador == null) {
            ...
            jpBuscador.setSize(new Dimension(300,65));
    ...
    public JButton getJBCargar() {
        if (jbCargar == null) {
            ...
            jbCargar.setPreferredSize(new Dimension(80,25));
    ...
    public JButton getJBMod() {
        if (jbModif == null) {
            ...
            jbModif.setPreferredSize(new Dimension(80,25));
    ...
    public JButton getJBBorrar() {
        if (jbBorrar == null) {
            ...
            jbBorrar.setPreferredSize(new Dimension(80,25));
    ...
    public JButton getJBImprimir() {
        if (jbImprimir == null) {
        	...
        	jbImprimir.setPreferredSize(new Dimension(80,25));
    ...
    public JTable getJTDatos() {
        if (jtDatos == null) {
            ...
            TableColumn columna9 = jtDatos.getColumn("Stock Actual Kg");
            columna9.setCellRenderer(Utils.alinearDerecha());
            TableColumn columna10 = jtDatos.getColumn("Stock Mínimo Kg");
    ...
    public JTextField getJTFBuscadorCodigo() {
        if (jtfCodigo == null) {
        	...
        	jtfCodigo.setPreferredSize(new Dimension(50,22));
