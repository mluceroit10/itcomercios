...
public class GUIListarFacturasClienteP extends JDialog {
	...
	public GUIListarFacturasClienteP(int mes,int anio,JFrame guiPadre) {
    	super(guiPadre);
    	mesLI=mes;
		anioLI=anio;
	...
	public GUIListarFacturasClienteP(int mes,int anio,JDialog guiPadre) {
    	super(guiPadre);
    	mesLI=mes;
		anioLI=anio;
		datos = new Object[0][titulos.length];
    ...
    private JPanel getJPDatos() {
        if (jpDatos == null) {
            ...
            jpDatos.setBorder(javax.swing.BorderFactory.createTitledBorder(Utils.b, "Facturas Cliente",
                    javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
